 ...
 * @function
 */
public class OwInterstitialAdImpl implements InterstitialAdService {
    ...
    public void initAD(Activity activity, String placementId, AdListenter adListener) {
        //创建插屏视频事件监听器
        OWInterstitialAdListener owInterstitialAdListener = new OWInterstitialAdListener() {
            @Override
        ...
        //创建插屏视频对象
        owInterstitialAd = new OWInterstitialAd(activity, placementId, owInterstitialAdListener);
    }
    ...
    public void show(Activity activity, String tag) {
        owInterstitialAd.show(activity, tag);
    }
